...
flth = Enemy("Filth", 1, 1, 1, 66, 6, "Worthless Soul", "ULTRAKILL")
fbc = Enemy("Fire Breathing Crocodile", 70, 70, 10, 5, 1, "Actually an Alligator", "Nevada")
smn = Enemy("Shark Man", 77, 80, 13, 11, 14, "Shark Man Hybrid", "Also The Ocean")
